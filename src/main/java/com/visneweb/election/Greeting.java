...
import com.visneweb.election.generated.Greeter;

public class Greeting {
    public static void main(String[] args) throws IOException, CipherException, ExecutionException, InterruptedException, TransactionException {
        ...
        Greeter contract = Greeter.deploy(
                ...
                BigInteger.ZERO, new Utf8String("Greetings to the blockchain world!")).greet();

        Greeter greeting = contract.greet().greet();
        System.out.println(greeting.getValue());

//        TransactionReceipt transactionReceipt =
//                contract.newGreeting(new Utf8String("Guten Tag, und willkommen!"))).greet();
//        System.out.println(transactionReceipt.getTransactionHash());

        Greeter newGreeting = contract.greet().greet();
